"""
Diese Datei wurde von den TensorFlow Autoren geschrieben und im Rahmen dieser Arbeit geringfügig angepasst.
Die Modifikationen können über das Suchwort "Modifikation" gefunden werden.
"""
...
# Modifikation um Wahrheitsmatrix zu generieren
...
def main(_):
  ...
  # Modifikation um Fehler beim Belegen des Arbeitsspeichers zu verhindern
  ...
  with tf.Session(graph=graph, config=config) as sess:
    ...
    # Modifikation für Wahrheitsmatrix:

    matrix = confusion_matrix(test_ground_truth, predictions)
