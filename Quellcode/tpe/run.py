...
if __name__ == '__main__':
    ...
    image_black = np.zeros((image.shape[0], image.shape[1], 3), np.uint8)
    ...
    cv2.imwrite(args.image+"_converted.jpg", image)
    cv2.imwrite(args.image + "_converted_black.jpg", pose_image_black)
